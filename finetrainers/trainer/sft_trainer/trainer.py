...
class SFTTrainer:
        ...
        def save_model_hook(state_dict: Dict[str, Any], step) -> None:
            if parallel_backend.is_main_process:
                if self.args.training_type == TrainingType.LORA:
                    ...
                    self.model_specification._save_lora_weights(self.args.output_dir, step, self.transformer, state_dict, self.scheduler)
    ...
    def _train(self) -> None:
        ...
        while (
            ...
            if False and self.transformer.whether_classifier:
    ...
    def _init_distributed(self) -> None:
        ...
        dist_backend = os.environ.get("FINETRAINERS_DIST_BACKEND")
        if not dist_backend:
            dist_backend = "gloo" if world_size == 1 else "nccl"
