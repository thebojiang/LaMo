...
def get_lr_scheduler_lambda(
    ...
    """Return the bare lambda function for a named LR schedule (no optimizer needed)."""
    name = name.lower()
    if name == "constant":
        return get_constant_schedule()
    elif name == "constant_with_warmup":
        return get_constant_schedule_with_warmup(num_warmup_steps)
    elif name == "piecewise_constant":
        return get_piecewise_constant_schedule(step_rules)
    elif name == "linear":
        return get_linear_schedule_with_warmup(num_warmup_steps, num_training_steps)
    elif name == "cosine":
        return get_cosine_schedule_with_warmup(num_warmup_steps, num_training_steps, num_cycles)
...
def get_lr_scheduler(
    ...
    scheduler_lambda_fn = get_lr_scheduler_lambda(
        name, step_rules, num_warmup_steps, num_training_steps,
        num_cycles, power, lr_init, lr_end,
    )
