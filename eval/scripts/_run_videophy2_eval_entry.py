...
"""Internal torchrun entrypoint for local VideoPhy2 evaluation.

Users should launch ``eval/scripts/run_videophy2_eval.sh``.  This helper
exists because torchrun starts one Python file per rank.
"""
...
from eval.cluster_videophy2_eval import main
...
def build_config() -> dict:
    cfg = {
        ...
        "entailment_eval_timeout_seconds": _get_int("ENTAILMENT_EVAL_TIMEOUT_SECONDS", "21600"),
